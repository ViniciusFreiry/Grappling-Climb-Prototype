if(pause_timer > 0) {
	...
	// Banner
	draw_sprite_ext(spr_banner, 0, draw_x, draw_y - 82, menu_scale, 1, 0, c_white, 1);
	...
	// Book
	draw_sprite_ext(spr_cover, 0, draw_x, draw_y, menu_scale, 1, 0, c_white, 1);
	draw_sprite_ext(spr_page_left, 0, draw_x, draw_y, menu_scale, 1, 0, c_white, 1);
	draw_sprite_ext(spr_page_right, 0, draw_x, draw_y, menu_scale, 1, 0, c_white, 1);
